...
# change it
from streamer.web import web
from streamer.api import api

import logging
from logging.handlers import RotatingFileHandler

application = Flask(__name__,\
                    static_folder="streamer/static/",\
                     template_folder="streamer/templates/",
...
rotatingfile_handler = RotatingFileHandler('streamer.log', maxBytes=10000, backupCount=1)
